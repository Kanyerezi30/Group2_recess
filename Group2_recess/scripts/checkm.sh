...
head -138 ${path}/assembly_contamination/checkmoutput.tsv | tail -103 | awk '$15 < 10 && $14 > 80' | awk '{print $1}' | cut -f1 -d"_" > ${path}/assembly_contamination/passed_contamination_ids.txt # extract those with acceptable contamination levels
